...
@patch("utils.file_helpers.PORTFOLIOS_DIR")
...
@patch("utils.file_helpers.PortfolioRepository")
@patch("utils.file_helpers.PORTFOLIOS_DIR")
...
def test_save_portfolio(mock_dir, mock_repo_class):
    ...
    mock_repo_instance.save_to_json.assert_called_once_with(mock_portfolio, "fake/output.json")
